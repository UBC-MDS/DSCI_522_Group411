...
To perform this anlaysis, the R and Python programming languages [@r; @Python] as well as the following R and Python packages were used: `caret` [@caret], `docopt` [@docopt], `feather` [@feather], `tidyverse` [@tidyverse], `lubridate` [@lubridate], `car` [@car], `kableExtra` [@kableExtra], `reshape2` [@reshape2], `tidyverse` [@tidyverse], `broom` [@broom], `knitr` [@knitr], `ggpubr` [@ggpubr], `RCurl` [@RCurl], `pandas` [@pandas], `numpy` [@numpy], `selenium` [@selenium], `scikit-learn` [@scikit-learn], and `altair` [@2018-altair].
